...
//configuracion del proceso de mapeo con hibernate para que lea todas las clases que tiene como definicion como componente
...
public class SwadopcionInfraestructureConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        enf.setPackagesToScan(Mascota.class.getPackage().getName());
        ...
        enf.setJpaVendorAdapter(hibernateJpa);
